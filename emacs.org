...
ctrl + x up / down     -> move to the upper / downer window
...
f9                    - fetch tickets from redmine
  -> tab -> subtree   - to insert sub tree (while in your TODO.org)
ctrl + x t i          - fetch issue (while in your TODO.org)

ctrl + c ctrl + x ctrl + i - start timer
ctrl + c ctrl + x ctrl + o - stop timer
...
* Project							      :emacs:
esc+x project-load  -> load a project
esc+x project-save  -> save desktop as project
* Macros 							      :emacs:
