...
=======
ctl + c +             - sum up columns in org-table
>>>>>>> e31de9c73e968c0a5fdc4b92b59cc5ce008cad86
...
esc + x dired-toggle-read-only - mass rename files in buffer press C-c C-c to commit changes
